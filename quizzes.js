...
const LSN_QUIZZES = [
  {
    ...
    questions:[
      ...
      {q:"How do you handle being ignored?", a:[["I ask directly what's going on.","open"],["I match the silence and go quiet too.","dead"],["I replay the moment until it means something else.","echo"],["I assume something's wrong and go into fix-it mode.","emergency"]]},
      {q:"What's your relationship with rules?", a:[["They're optional if I have a good enough reason.","pirate"],["I follow them and expect the same back.","open"],["I bend them quietly, nobody notices.","static"],["I follow them in public, less so in private.","midnight"]]},
      {q:"Someone finally reaches you after days of silence.", a:[["I respond eventually, on my own time.","dead"],["I've already rehearsed what I'd say.","echo"],["I let them in more than I planned to.","midnight"],["I just tell them what took so long.","open"]]},
      {q:"What does your inner circle get that nobody else does?", a:[["The version of me that isn't performing.","midnight"],["Nothing different, honestly, I'm consistent.","open"],["Access to plans nobody approved.","pirate"],["The real meaning behind my jokes.","static"]]}
    ]
  },
  {
    id:"redflag",
    ...
    questions:[
      ...
      {q:"Somebody catches feelings faster than you did.",a:[["I start pulling back immediately.","runner"],["I try to match their energy so nobody gets hurt.","fixer"],["I need to know exactly where this is going.","control"],["I stop replying for a few days.","avoid"]]},
      {q:"You're accused of being the problem.",a:[["I deny it and make a joke instead.","chaos"],["I probably am, but I'll fix it.","fixer"],["I explain my reasoning at length.","control"],["I disappear before it turns into a real conversation.","avoid"]]},
      {q:"What's the actual reason you're single or keep things casual?",a:[["Getting close means eventually getting left.","runner"],["Nobody's met my standards yet.","control"],["I keep 'fixing' people who don't want fixed.","fixer"],["Chaos keeps finding me either way.","chaos"]]}
    ]
  },
  {
    id:"midnight",
    ...
    questions:[
      ...
      {q:"You can't sleep. What's actually keeping you up?",a:[["A conversation I can't stop replaying.","restless"],["Someone I wish were here.","lonely"],["A version of my life that hasn't happened yet.","dreamer"],["Nothing I'd actually admit to.","guarded"]]},
      {q:"Somebody asks what you're thinking about.",a:[["The truth, if I trust them.","soft"],["Something I'll deflect from.","guarded"],["Whoever's on my mind lately.","lonely"],["A plan I haven't told anyone yet.","dreamer"]]},
      {q:"Your late-night texts, if you send them, are usually...",a:[["Deleted before I send them.","guarded"],["Sent to the one person who'll actually understand.","soft"],["Long, unfiltered, and a little too honest.","restless"],["Never sent. I just think about sending them.","lonely"]]},
      {q:"What does the version of you at 3 AM want most?",a:[["To be held, honestly.","soft"],["For my brain to just stop for one night.","restless"],["Someone to reach out first, for once.","lonely"],["To keep this part of me exactly where it is.","guarded"]]}
    ]
  },
  {
    id:"crisis",
    ...
    questions:[
      ...
      {q:"Someone freezes up mid-crisis.",a:[["I physically move them out of the way.","runner"],["I stay right beside them until they can move.","anchor"],["I bark an order, that usually snaps people out of it.","captain"],["I check if they're hurt before anything else.","medic"]]},
      {q:"You're handed a job with zero instructions.",a:[["I make up a plan on the spot.","wildcard"],["I ask who's actually in charge here.","captain"],["I do whatever keeps people calm.","anchor"],["I figure out the fastest way out first.","runner"]]},
      {q:"What do people actually thank you for afterward?",a:[["Staying so calm nobody else panicked.","anchor"],["Taking charge when nobody else would.","captain"],["Getting them out safely.","runner"],["Patching them up before it got worse.","medic"]]},
      {q:"Mid-crisis, what's running through your head?",a:[["Somebody has to make the calls here.","captain"],["Is everyone physically okay.","medic"],["This is a terrible idea and I'm doing it anyway.","wildcard"],["Just get through the next five minutes.","anchor"]]},
      {q:"What's your actual crisis instinct, underneath all of it?",a:[["Control the chaos before it controls everyone.","captain"],["Protect the people, not the situation.","medic"],["Survive first, process later.","runner"],["Improvise. There's no time for a real plan.","wildcard"]]}
    ]
  },
  {
    id:"love",
    ...
    questions:[
      ...
      {q:"Someone else shows interest in your person.",a:[["I don't say anything, I just make sure they know I'm not going anywhere.","presence"],["I get noticeably closer for a while.","possession"],["I fix something they didn't ask me to fix.","repair"],["I make a joke that's only half a joke.","tease"]]},
      {q:"How do you actually apologize?",a:[["I say sorry and then just show up more.","presence"],["I fix whatever I broke, literally or otherwise.","repair"],["I get quiet and hope they notice I feel bad.","quiet"],["I make fun of myself until it's funny again.","tease"]]},
      {q:"What's the tell that you actually like someone?",a:[["I remember things they didn't think I was listening to.","quiet"],["I start bothering them specifically.","tease"],["I show up, consistently, without being asked.","presence"],["I get a little possessive of their attention.","possession"]]},
      {q:"They're sick or having a rough week.",a:[["I show up with something they need before they ask.","repair"],["I just stay close, I don't need to do much else.","presence"],["I check on them more than I'd admit to.","quiet"],["I tease them into feeling normal again.","tease"]]},
      {q:"What's the version of 'I love you' you'd actually say out loud?",a:[["I'm not going anywhere.","presence"],["You're mine, obviously.","possession"],["I noticed. I always notice.","quiet"],["I'm never going to stop annoying you.","tease"]]}
    ]
  },
  {
    id:"chaos",
  ...
  {id:"socialbattery",number:"007",title:"SOCIAL BATTERY",question:"How long before your character needs everybody to go home?",description:"A diagnosis of your character's people tolerance, recharge habits and social survival strategy.",time:"2 min",categories:["solar","selective","night","ghost"],results:{
    ...
    {q:"How do you actually recharge?",a:[["Being around more people, somehow.","solar"],["One-on-one time with someone I trust.","selective"],["Doing my own thing once the world quiets down.","night"],["Total isolation, phone off.","ghost"]]},
    {q:"Someone invites you to something last minute.",a:[["I'm already getting ready.","solar"],["Depends entirely on who's going.","selective"],["Only if it starts after 9.","night"],["They already know not to bother asking.","ghost"]]},
    {q:"Your ideal night looks like...",a:[["A packed room and good energy.","solar"],["A few people, low stakes, good conversation.","selective"],["Everyone else asleep, finally some peace.","night"],["Nobody. Just me and silence.","ghost"]]},
    {q:"How many texts do you leave on read?",a:[["None, I reply to everything fast.","solar"],["Only the ones from people I'm not that close to.","selective"],["All of them until it's late enough to think straight.","night"],["Most of them, for days.","ghost"]]},
    {q:"What does your friend group say about you?",a:[["Always down, always there.","solar"],["Reliable but picky about plans.","selective"],["A completely different person after midnight.","night"],["We forget what they look like sometimes.","ghost"]]},
    {q:"A get-together runs long. What happens?",a:[["I'm still going strong.","solar"],["I quietly duck out at a reasonable hour.","selective"],["I finally start having fun.","night"],["I left an hour ago without telling anyone.","ghost"]]}]},
  {id:"moral",number:"008",title:"MORAL COMPASS MALFUNCTION",question:"How far would your character actually go?",description:"A fictional-character morality quiz for bad decisions, loyalty and convenient ethics.",time:"3 min",categories:["lawful","loyal","gray","wild"],results:{
    ...
    questions:[{q:"Your best friend committed a serious mistake.",a:[["Make them face it.","lawful"],["Protect them first.","loyal"],["Depends what happened.","gray"],["Help hide it.","wild"]]},{q:"You can get away with cheating the system.",a:[["Still no.","lawful"],["Only if somebody needs me to.","loyal"],["Probably.","gray"],["Already did.","wild"]]},{q:"A stranger needs help that puts you at risk.",a:[["Help within reason.","lawful"],["I help if I care.","loyal"],["I calculate the risk.","gray"],["Risk makes it interesting.","wild"]]},{q:"What matters most?",a:[["Doing right.","lawful"],["My people.","loyal"],["The outcome.","gray"],["My own code.","wild"]]},{q:"Would you break a promise to do the right thing?",a:[["Never, a promise is a promise.","lawful"],["Only to protect someone I love.","loyal"],["If the original promise was flawed.","gray"],["Promises are more like guidelines.","wild"]]},{q:"Your character finds evidence against someone they love.",a:[["Turn it in. Truth first.","lawful"],["Bury it, no question.","loyal"],["Weigh who else it affects.","gray"],["File it away for later use.","wild"]]},{q:"How do you feel about vigilante justice?",a:[["Dangerous. Let the system work.","lawful"],["Justified, if it's for my people.","loyal"],["Depends entirely on the target.","gray"],["Honestly? Kind of appealing.","wild"]]},{q:"Someone offers you power in exchange for compromise.",a:[["I walk away.","lawful"],["Depends who benefits.","loyal"],["I'd need more details first.","gray"],["I'm already negotiating terms.","wild"]]},{q:"What's your relationship with authority?",a:[["I respect it, mostly.","lawful"],["I respect the people, not the title.","loyal"],["I use it when it's useful.","gray"],["I don't really recognize it.","wild"]]},{q:"A rule stands between you and someone you care about.",a:[["I find a legal way around it.","lawful"],["I break it without a second thought.","loyal"],["I decide based on the stakes.","gray"],["Rules like that don't really apply to me.","wild"]]},{q:"How would your enemies describe your ethics?",a:[["Rigid, but fair.","lawful"],["Nonexistent unless someone he loves is involved.","loyal"],["Impossible to predict.","gray"],["Nonexistent, full stop.","wild"]]},{q:"What finally makes you cross a line?",a:[["Overwhelming, undeniable evidence.","lawful"],["Someone I love being threatened.","loyal"],["When the math finally makes sense.","gray"],["I crossed it a while ago.","wild"]]}]},
  {id:"texting",number:"009",title:"TEXTING STYLE",question:"What kind of texter is your character?",description:"Because entire relationships have been ruined by punctuation and read receipts.",time:"2 min",categories:["fast","dry","essay","ghost"],results:{
    ...
    questions:[{q:"Somebody says 'wyd'.",a:[["Answer immediately.","fast"],["'nm'","dry"],["Give the whole itinerary.","essay"],["See it and forget.","ghost"]]},{q:"Argument by text?",a:[["Real-time battle.","fast"],["One terrifying sentence.","dry"],["Paragraphs.","essay"],["Mute notifications.","ghost"]]},{q:"Read receipts?",a:[["On.","fast"],["Does not matter.","dry"],["Useful for evidence.","essay"],["Absolutely off.","ghost"]]},{q:"Voice notes?",a:[["Yes.","fast"],["No.","dry"],["Only if the story is long.","essay"],["Listen, forget to answer.","ghost"]]},{q:"You're double-texted.",a:[["I've already answered both.","fast"],["Now I'm annoyed.","dry"],["I answer the whole thread at once, thoroughly.","essay"],["I saw the first one three days ago.","ghost"]]},{q:"How do you feel about typing indicators?",a:[["Love watching it, love using it.","fast"],["Doesn't matter, my replies are short anyway.","dry"],["Anxiety-inducing when I'm mid-paragraph.","essay"],["I turn mine off entirely.","ghost"]]},{q:"Someone sends a wall of text.",a:[["I respond point by point, fast.","fast"],["'ok'","dry"],["Finally, someone who gets it.","essay"],["I'll read it eventually. Probably.","ghost"]]},{q:"Your typical text sign-off?",a:[["None, I just stop typing.","fast"],["None. Just silence after the last word.","dry"],["A full closing paragraph.","essay"],["There isn't one, the conversation just dies.","ghost"]]},{q:"A group chat gets chaotic.",a:[["I'm in the thick of it, typing fast.","fast"],["One dry comment and I'm out.","dry"],["I write a summary nobody asked for.","essay"],["I mute it and check back in a week.","ghost"]]},{q:"What's a text-worthy emergency to you?",a:[["Anything, honestly, I text fast either way.","fast"],["Genuinely nothing. Call me.","dry"],["Something worth a proper explanation.","essay"],["I'll see it when I see it.","ghost"]]},{q:"How do you feel about being left on read?",a:[["Doesn't happen to me much, I reply too fast.","fast"],["Doesn't bother me at all.","dry"],["I replay what I said and spiral a little.","essay"],["I do it to other people constantly, so, fair.","ghost"]]},{q:"Your texting energy in one word?",a:[["Immediate.","fast"],["Efficient.","dry"],["Thorough.","essay"],["Eventual.","ghost"]]}]},
  {id:"rumor",number:"010",title:"RUMOR SURVIVAL TEST",question:"How does your character handle being talked about?",description:"A stress test for gossip, reputation and being perceived against your will.",time:"2 min",categories:["ignore","fight","spin","spiral"],results:{
    ...
    questions:[{q:"You hear a rumor about yourself.",a:[["Ignore it.","ignore"],["Find the source.","fight"],["Correct it strategically.","spin"],["Ask five people what they heard.","spiral"]]},{q:"The rumor is partly true.",a:[["Still nobody's business.","ignore"],["Then say it to me.","fight"],["Release the cleaner version.","spin"],["This is now a crisis.","spiral"]]},{q:"Someone asks directly.",a:[["'No comment.'","ignore"],["'Who told you?'","fight"],["Give the version I want repeated.","spin"],["Over-explain.","spiral"]]},{q:"Your reputation matters...",a:[["Less than peace.","ignore"],["Enough to defend.","fight"],["A lot.","spin"],["More than I admit.","spiral"]]},{q:"A rumor about you gets back to someone you're close to.",a:[["I let them draw their own conclusions.","ignore"],["I confront whoever started it, in front of them if needed.","fight"],["I get to them first with the real story.","spin"],["I panic and over-explain before they even ask.","spiral"]]},{q:"How often do you check what people are saying about you online?",a:[["Never, on principle.","ignore"],["Only when I'm ready to respond.","fight"],["Regularly, so I know what to manage.","spin"],["Constantly, against my own advice to myself.","spiral"]]},{q:"Someone spreads something that's flat-out false.",a:[["Let it die on its own.","ignore"],["Publicly, immediately, incorrect.","fight"],["Quietly plant the truth somewhere it'll spread.","spin"],["Lose sleep over it for a week.","spiral"]]},{q:"What's your actual goal when a rumor starts?",a:[["Make it boring so it dies.","ignore"],["Make it clear there are consequences.","fight"],["Control which version survives.","spin"],["Just make it stop, somehow.","spiral"]]},{q:"A friend defends you without asking first.",a:[["I'd rather they hadn't bothered.","ignore"],["Good. That's what I'd do for them.","fight"],["I appreciate it, then I refine the messaging.","spin"],["I'm grateful, but now I'm also anxious about it.","spiral"]]},{q:"What's the actual worst part of being talked about?",a:[["Nothing, it's mostly just noise to me.","ignore"],["Not getting the chance to respond directly.","fight"],["Losing control of the narrative.","spin"],["Not knowing exactly what's being said.","spiral"]]}]},
  ...
  {id:"foundfamily",number:"012",title:"FOUND FAMILY ROLE",question:"What role do you play in your found family?",description:"The people who chose you, and the role you never technically applied for.",time:"2 min",categories:["protector","jokester","mediator","glue","wildcard"],results:{
    ...
    questions:[{q:"Someone in the group is struggling.",a:[["I handle the problem directly.","protector"],["I make them laugh until it's bearable.","jokester"],["I check in and ask what they need.","mediator"],["I quietly reorganize everyone's plans around them.","glue"]]},{q:"A fight breaks out between two members.",a:[["I pick a side, loudly.","protector"],["I make a joke that de-escalates or ruins everything.","jokester"],["I get everyone in a room to talk it out.","mediator"],["I make it worse, accidentally.","wildcard"]]},{q:"Your role at every gathering?",a:[["Making sure it actually happens.","glue"],["Comic relief, mandatory.","jokester"],["Watching the door, basically.","protector"],["Unpredictable but essential.","wildcard"]]},{q:"What do they come to you for?",a:[["Backup.","protector"],["Advice nobody else will give straight.","mediator"],["Logistics and emotional infrastructure.","glue"],["A distraction.","jokester"]]},{q:"If the family fell apart, it'd be because...",a:[["I finally stopped holding it together.","glue"],["Nobody would talk to each other anymore.","mediator"],["I couldn't protect everyone at once.","protector"],["Someone finally snapped from all the chaos I caused.","wildcard"]]},{q:"How do you show love, actually?",a:[["Standing guard, quietly.","protector"],["Making sure everyone's laughing again.","jokester"],["Translating between people who don't get each other.","mediator"],["Remembering everyone's schedule better than they do.","glue"]]},{q:"What's your seat at the table?",a:[["Closest to the door, watching it.","protector"],["Wherever the joke lands best.","jokester"],["In the middle, on purpose.","mediator"],["Nobody assigned it, I just always end up hosting.","glue"]]},{q:"Someone new joins the family. Your first move?",a:[["Quietly assess if they're safe to trust.","protector"],["Make them laugh so they relax.","jokester"],["Introduce them to everyone properly.","mediator"],["Chaos, immediately, on purpose.","wildcard"]]},{q:"What do people worry about, regarding you?",a:[["That you never let anyone protect you back.","protector"],["That you're using jokes to avoid something real.","jokester"],["That you absorb everyone's conflict and never your own.","mediator"],["Honestly, just what you'll do next.","wildcard"]]},{q:"The family's in crisis. What's your job?",a:[["Handle the actual threat.","protector"],["Keep morale from collapsing.","jokester"],["Keep everyone talking to each other.","mediator"],["Somehow make it worse, then somehow fix it.","wildcard"]]},{q:"Who remembers everyone's birthdays, allergies, and bad exes?",a:[["Not me, but I'll fight for whoever needs it.","protector"],["Me, and I bring it up at the worst times, lovingly.","jokester"],["Me, quietly, so nobody's ever caught off guard.","glue"],["Definitely not me, I forget my own.","wildcard"]]},{q:"What's your reputation within the group?",a:[["The one who shows up when it matters.","protector"],["The one who never lets things get too serious.","jokester"],["The one holding the actual schedule together.","glue"],["The one nobody can predict, in a good way.","wildcard"]]}]},
  {id:"firstimpression",number:"013",title:"FIRST IMPRESSION VS. REALITY",question:"How wrong is everyone's first impression of you?",description:"The gap between the version people meet and the version they actually get.",time:"2 min",categories:["exact","opposite","surface","slowburn"],results:{
    ...
    questions:[{q:"Someone meets you for the first time. Their read?",a:[["Pretty much accurate, actually.","exact"],["Wildly, hilariously wrong.","opposite"],["They get maybe 10% of the picture.","surface"],["Not wrong, just incomplete.","slowburn"]]},{q:"How long before someone knows the 'real' you?",a:[["Immediately, I don't perform.","exact"],["They never fully catch up.","opposite"],["Most people never bother.","surface"],["Months. Sometimes longer.","slowburn"]]},{q:"What do people assume about you that's false?",a:[["Nothing much, I don't hide well.","exact"],["Almost everything.","opposite"],["That the surface is all there is.","surface"],["That I'm simpler than I am.","slowburn"]]},{q:"Do you correct people's wrong assumptions?",a:[["There's rarely anything to correct.","exact"],["Sometimes it's funnier not to.","opposite"],["I don't think they'd believe me anyway.","surface"],["Eventually, if they stick around.","slowburn"]]},{q:"Your first impression is best described as...",a:[["An honest preview.","exact"],["A decoy.","opposite"],["A locked door.","surface"],["A slow unlock.","slowburn"]]},{q:"A new person asks your close friends what you're 'really like.'",a:[["They'll say basically what you'd expect.","exact"],["The answer will genuinely shock them.","opposite"],["'Ask them yourself, good luck.'","surface"],["'Give it time, it's worth it.'","slowburn"]]},{q:"How do you act when you're meeting someone new?",a:[["Same as always.","exact"],["A curated, misleading version of myself.","opposite"],["Guarded, on purpose.","surface"],["A little reserved, without meaning to be.","slowburn"]]},{q:"Someone who's known you for years describes meeting you.",a:[["'Pretty much what I still see now.'","exact"],["'I had you completely wrong.'","opposite"],["'I didn't know anything for months.'","surface"],["'It took a while, but it was worth the wait.'","slowburn"]]},{q:"What's the most common thing people get wrong about you?",a:[["Honestly, not much.","exact"],["Almost the entire premise.","opposite"],["That there's nothing more to find.","surface"],["That I'm this simple all the way through.","slowburn"]]},{q:"How do you feel about being misjudged?",a:[["Rarely an issue for me.","exact"],["Kind of useful, actually.","opposite"],["Expected, and a little lonely.","surface"],["Frustrating, but I get it.","slowburn"]]}]},
  {id:"breakupstyle",number:"014",title:"BREAKUP STYLE",question:"How does your character actually end things?",description:"Not how they want to handle it. How they actually do.",time:"2 min",categories:["ghost","blowup","closure","mourner"],results:{
    ...
    questions:[{q:"It's over. What's your first move?",a:[["Disappear, no announcement.","ghost"],["Say everything I've been holding back.","blowup"],["Ask for one honest conversation.","closure"],["Pretend it isn't, for a while.","mourner"]]},{q:"A few weeks later, you're...",a:[["Already gone, mentally and otherwise.","ghost"],["Still slightly furious.","blowup"],["Processing it out loud with everyone.","closure"],["Rereading old messages.","mourner"]]},{q:"What do you need to actually move on?",a:[["Distance. Total distance.","ghost"],["To say my piece.","blowup"],["Answers.","closure"],["Time. A lot of it.","mourner"]]},{q:"How do mutual friends find out?",a:[["They notice the silence eventually.","ghost"],["Everyone knows within the hour.","blowup"],["I tell people directly, calmly.","closure"],["I avoid the topic entirely.","mourner"]]},{q:"Your last message to them was...",a:[["There wasn't one.","ghost"],["Long, and I don't regret it.","blowup"],["A clear, fair explanation.","closure"],["Something I probably shouldn't have sent.","mourner"]]},{q:"How do you feel a month later?",a:[["Already fully moved on.","ghost"],["Still a little satisfied I said it.","blowup"],["At peace, mostly.","closure"],["Still checking their socials.","mourner"]]},{q:"They try to reach out after it's over.",a:[["I don't respond.","ghost"],["I tell them exactly why that's not happening.","blowup"],["I hear them out, calmly.","closure"],["I answer faster than I'd like to admit.","mourner"]]},{q:"What do you delete first?",a:[["Everything, immediately.","ghost"],["Nothing, I want the receipts.","blowup"],["The stuff that's just clutter, eventually.","closure"],["Nothing. I revisit it more than I should.","mourner"]]},{q:"How does your circle describe the breakup?",a:[["'Wait, they broke up?'","ghost"],["'Everyone heard about it. Everyone.'","blowup"],["'They handled it really maturely.'","closure"],["'They're still not over it.'","mourner"]]},{q:"What do you actually need to fully let go?",a:[["Nothing. I'm already gone.","ghost"],["To feel like I had the last word.","blowup"],["A real, honest conversation.","closure"],["Time I keep insisting I don't need.","mourner"]]}]},
  {id:"secretkeeping",number:"015",title:"SECRET-KEEPING APTITUDE",question:"How well does your character actually keep a secret?",description:"Everyone says they're good at this. Statistically, they are not.",time:"2 min",categories:["vault","leaky","selective","burden"],results:{
    ...
    questions:[{q:"Someone tells you something huge in confidence.",a:[["It's already gone from my active memory.","vault"],["I mean to keep it quiet.","leaky"],["I file it away for later use.","selective"],["I carry it like a physical weight.","burden"]]},{q:"Your friend asks if you know anything about a rumor.",a:[["I say nothing, convincingly.","vault"],["I panic and confirm too much.","leaky"],["I give them exactly what I want them to have.","selective"],["I visibly struggle not to say something.","burden"]]},{q:"How many people actually know your real secrets?",a:[["Zero. Maybe one.","vault"],["More than I meant to tell.","leaky"],["Exactly the people I chose.","selective"],["Nobody, and it's exhausting.","burden"]]},{q:"You're offered information in exchange for a secret.",a:[["Not interested. I don't trade in that.","vault"],["I'd probably slip either way.","leaky"],["Depends what's on the table.","selective"],["I'd rather not know either thing.","burden"]]},{q:"What happens when you're keeping too many secrets at once?",a:[["Nothing. I compartmentalize fine.","vault"],["One of them eventually surfaces.","leaky"],["I decide which ones still matter.","selective"],["I start to unravel a little.","burden"]]},{q:"Someone tests you to see if you'll talk.",a:[["I don't even register it as a test.","vault"],["I probably fail without noticing.","leaky"],["I clock it immediately and give nothing away.","selective"],["I get visibly nervous, which gives it away anyway.","burden"]]},{q:"How do you feel physically when you're sitting on a secret?",a:[["Totally normal. No different.","vault"],["Antsy, like it wants out.","leaky"],["Fine, as long as I've decided it's worth keeping.","selective"],["Heavy. Genuinely heavy.","burden"]]},{q:"A friend tells you 'don't tell anyone, not even them.'",a:[["Understood, done, forgotten.","vault"],["I'll try, but no promises.","leaky"],["I decide right then who 'anyone' actually excludes.","selective"],["Now I'm anxious every time I'm near that person.","burden"]]},{q:"Why do people trust you with secrets in the first place?",a:[["I've simply never told one.","vault"],["Honestly, I'm not sure they should.","leaky"],["I've earned it, selectively.","selective"],["They know I'll suffer for it, so I must mean it.","burden"]]},{q:"What's your actual secret-keeping motto?",a:[["What I don't say, I don't say.","vault"],["I try my best, that's all anyone can ask.","leaky"],["Some things are currency.","selective"],["Silence has a cost, and I pay it.","burden"]]}]},
  {id:"downfalltype",number:"016",title:"DOWNFALL TYPE",question:"What will actually be your character's undoing?",description:"Every character has a fatal flaw. This is a diagnosis, not a warning.",time:"2 min",categories:["pride","love","loyalty","ambition"],results:{
    ...
    questions:[{q:"You're offered an easy way out, but it requires admitting fault.",a:[["I'll find a harder way instead.","pride"],["I take it if it protects someone I love.","love"],["I take it only if it doesn't betray my people.","loyalty"],["I take it if it keeps me on track.","ambition"]]},{q:"Someone you love asks you to stop pursuing something dangerous.",a:[["I resent being asked at all.","pride"],["I stop, immediately.","love"],["I ask what they need from me instead.","loyalty"],["I say I will and don't.","ambition"]]},{q:"What's the one thing you can't walk away from?",a:[["Being proven right.","pride"],["A person.","love"],["My people, no matter what they've done.","loyalty"],["The goal. Whatever it costs.","ambition"]]},{q:"Your allies warn you that you're going too far.",a:[["I don't hear warnings well.","pride"],["I stop the second it threatens someone I love.","love"],["I only stop if it's for them.","loyalty"],["I go further anyway.","ambition"]]},{q:"At the end, what do people say caused your fall?",a:[["He simply could not admit it.","pride"],["She would have done anything for that person.","love"],["They protected the wrong people, too well.","loyalty"],["They wanted it more than they wanted to survive it.","ambition"]]},{q:"You're given a chance to apologize and walk away clean.",a:[["I'd rather lose than apologize for nothing.","pride"],["I take it, if it protects them too.","love"],["I take it only if my people are safe first.","loyalty"],["I don't have time for apologies right now.","ambition"]]},{q:"What's the last thing you'd sacrifice?",a:[["My reputation.","pride"],["Them. Never them.","love"],["My people's trust in me.","loyalty"],["The goal. Everything else is negotiable.","ambition"]]},{q:"Someone points out you're making a mistake.",a:[["I resent the implication more than the mistake.","pride"],["I only listen if it's them saying it.","love"],["I only listen if it protects someone I answer for.","loyalty"],["I hear it and keep going anyway.","ambition"]]},{q:"What do you tell yourself right before it all falls apart?",a:[["I was right. I just wasn't believed.","pride"],["It was worth it, for them.","love"],["I'd do it again, for my people.","loyalty"],["I was so close.","ambition"]]},{q:"Who could actually stop you, at this point?",a:[["Nobody. I wouldn't allow it.","pride"],["Only them, and they haven't asked yet.","love"],["Only my own people, if it came to that.","loyalty"],["Nobody. There isn't time to be stopped.","ambition"]]}]},
  {id:"stormtype",number:"017",title:"STORM TYPE",question:"What kind of storm is your character when they finally break?",description:"Everybody has a breaking point. This is what it looks like from the outside.",time:"2 min",categories:["hurricane","quietfront","lightning","aftermath"],results:{
    ...
    questions:[{q:"You finally reach your breaking point. It looks like...",a:[["Everything, all at once, for a while.","hurricane"],["Sudden and total silence.","quietfront"],["One sharp, unmistakable moment.","lightning"],["A calm exterior hiding real damage.","aftermath"]]},{q:"How much warning do people get?",a:[["Plenty, if they were paying attention.","hurricane"],["None.","quietfront"],["None. It's instant.","lightning"],["They see the calm before, not the storm.","aftermath"]]},{q:"What's left after you break?",a:[["A lot to clean up.","hurricane"],["A noticeable chill that doesn't fully lift.","quietfront"],["One clean, specific mark.","lightning"],["Damage nobody notices until later.","aftermath"]]},{q:"How do you feel right after?",a:[["Wrung out completely.","hurricane"],["Nothing. Still nothing.","quietfront"],["Strangely lighter.","lightning"],["Fine, until I'm not.","aftermath"]]},{q:"People who've seen it happen describe you as...",a:[["Terrifying, honestly.","hurricane"],["Colder than they expected.","quietfront"],["Sharp. Precise.","lightning"],["Fine, until suddenly not.","aftermath"]]},{q:"How long does it take you to actually break?",a:[["A long, visible build-up.","hurricane"],["No build-up. Just off.","quietfront"],["Instant. No lead time at all.","lightning"],["It happens quietly, then all at once, later.","aftermath"]]},{q:"What do people do when they see it coming?",a:[["Brace, if they're smart.","hurricane"],["Nothing. There's nothing to see.","quietfront"],["Nothing. There's no time to.","lightning"],["They usually don't, until it's already over.","aftermath"]]},{q:"How do you apologize afterward, if you do?",a:[["Eventually, after the damage is assessed.","hurricane"],["I don't. The cold just lifts, eventually.","quietfront"],["Fast, and I mean it.","lightning"],["Quietly, once I've processed what happened.","aftermath"]]},{q:"What triggers it, usually?",a:[["A slow accumulation nobody addressed.","hurricane"],["One thing, crossed once too often.","quietfront"],["One specific, sharp betrayal.","lightning"],["Something small that hits a much older wound.","aftermath"]]},{q:"What's it like being close to you right before you break?",a:[["You can feel the pressure building for weeks.","hurricane"],["Nothing feels off, until it very suddenly is.","quietfront"],["Completely normal, until it isn't, for one second.","lightning"],["Calm on the surface, no idea what's underneath.","aftermath"]]}]},
  {id:"origingenre",number:"018",title:"ORIGIN STORY GENRE",question:"What genre is your character's origin story?",description:"If someone adapted your backstory into a film, what would the poster look like?",time:"2 min",categories:["tragedy","comedy","mystery","epic"],results:{
    ...
    questions:[{q:"How did your character's story actually start?",a:[["With a loss.","tragedy"],["With a mistake nobody could take back.","comedy"],["Nobody fully knows, including them.","mystery"],["With something bigger than them.","epic"]]},{q:"What's the tone of the flashback episode?",a:[["Quiet devastation.","tragedy"],["Chaotic, then devastating, then somehow funny again.","comedy"],["Fragmented. Unreliable.","mystery"],["Sweeping and dramatic.","epic"]]},{q:"What genre convention fits your backstory best?",a:[["The inevitable ending.","tragedy"],["The ridiculous misunderstanding.","comedy"],["The missing piece.","mystery"],["The chosen-by-circumstance arc.","epic"]]},{q:"How much of the full story is public?",a:[["Enough that people feel bad for me.","tragedy"],["All of it, and it's mortifying.","comedy"],["Almost none.","mystery"],["The highlight reel version.","epic"]]},{q:"The movie poster tagline would be...",a:[["Some things cannot be undone.","tragedy"],["It got so much worse before it got funny.","comedy"],["Nobody tells the whole story.","mystery"],["Everything led to this.","epic"]]},{q:"Who would narrate your origin story?",a:[["Someone who already knows how it ends.","tragedy"],["Someone laughing despite themselves.","comedy"],["Someone who's still piecing it together.","mystery"],["A voice that makes everything sound bigger.","epic"]]},{q:"What's the inciting incident?",a:[["Something taken that can't be given back.","tragedy"],["A plan that went hilariously wrong.","comedy"],["An event nobody can fully explain.","mystery"],["A moment history seemed to be waiting for.","epic"]]},{q:"How does the audience feel watching it?",a:[["Devastated, but they saw it coming.","tragedy"],["Uncomfortable, then laughing anyway.","comedy"],["Confused, in the best way.","mystery"],["Swept up in it completely.","epic"]]},{q:"What genre would your character insist it actually is?",a:[["They'd say it wasn't a tragedy at all.","tragedy"],["They wouldn't find it funny. Everyone else would.","comedy"],["They'd say there's nothing left to figure out.","mystery"],["They'd underplay how big it really was.","epic"]]},{q:"How does the story actually end, for now?",a:[["Not resolved. Just quieter.","tragedy"],["Somehow, fine. Against all odds.","comedy"],["Mid-sentence, deliberately.","mystery"],["On a note that promises there's more coming.","epic"]]}]},
