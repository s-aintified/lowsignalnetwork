...
const ORACLE_ANSWERS={
  yes:[
    ...
    "ALL FREQUENCIES AGREE. GO.","YES. STOP OVERTHINKING IT."
  ],
  no:[
    "ABSOLUTELY NOT. STAND UP.","NO. HANG UP THE PHONE.","STATIC SAYS NO. LISTEN TO IT.",
    "THE NETWORK DECLINES TO BE INVOLVED.","BAD IDEA. FULL STOP."
  ],
  maybe:[
    "ASK AGAIN AFTER MIDNIGHT.","SIGNAL TOO WEAK TO TELL.","WAIT TWO DAYS, THEN DECIDE.",
    "COULD GO EITHER WAY. THAT'S NOT NOTHING.","THE ANSWER IS IN THE TEXT YOU KEEP REREADING."
  ]
};
